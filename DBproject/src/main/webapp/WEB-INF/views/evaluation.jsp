		...
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					<li><a href="custom.jsp">고객평가페이지</a></li>
					<li><a href="friend.jsp">동료평가페이지</a></li>
					<li><a href="pm.jsp">PM평가페이지</a></li>
				</ul>
			</div>
			<!-- /.navbar-collapse -->
		</div>
		...
		<div class="row">
			<div class="col-md-3">
				...
				<div class="list-group">
					<a href="custom.jsp" class="list-group-item">고객평가페이지</a>
					<a href="friend.jsp"	class="list-group-item">동료평가페이지</a>
					<a href="pm.jsp"	class="list-group-item">PM평가페이지</a>
				</div>
			</div>
			<div class="col-md-9">
